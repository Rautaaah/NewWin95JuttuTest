...
(function(){if(!(document.currentScript instanceof HTMLScriptElement))return;
    ...
    if(url_structure == 'none') {
        function load_tlib(callback){if(!window.gt_translate_script){window.gt_translate_script=document.createElement('script');gt_translate_script.src='../cdn.gtranslate.net/widgets/latest/lib.min.js';document.body.appendChild(gt_translate_script);if(callback)gt_translate_script.addEventListener('load',callback,{once:true});}else{callback&&callback();}}
